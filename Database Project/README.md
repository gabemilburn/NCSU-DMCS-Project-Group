...
# Setting up to connect to the Python script. 

1. Check where your local workbench connection is located and ensure a password has been set. 

    1. In MySQLWorkbench you can do this by selecting the wrench icon above your local instance on the opening screen.
...
3. You will then be prompted to enter a UserID. This will determine your privileges when interacting with the rest of the program.

# Other Notes

1. This program was built for and executed using Python version 3.13.7.
