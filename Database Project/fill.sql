...
INSERT INTO User (UserID, Username, FirstName, LastName, UserRole) VALUES 
    ('MFG001', 'John Smith', 'John', 'Smith', 'MANUFACTURER'),
    ('MFG002', 'Alice Lee', 'Alice', 'Lee', 'MANUFACTURER'),
    ('SUP020', 'Jane Doe', 'Jane', 'Doe', 'SUPPLIER'),
    ('SUP021', 'James Miller', 'James', 'Miller', 'SUPPLIER'),
    ('VIEW001', 'Bob Johnson', 'Bob', 'Johnson', 'VIEWER');
