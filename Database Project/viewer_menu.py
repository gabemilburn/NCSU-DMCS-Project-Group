...
class ViewerMenu:
    ...
    def view_product_recipes_flattened(self):
        ...
        try:
            ...
            batch_quantity = selected_batch[5]
            ...
            # Get flattened ingredients from view
            self.cursor.execute("""
            ...
            if rows:
                ...
                total_oz = 0
                for r in rows:
                    qty_per_unit = r[2] / r[3]  # TotalQuantityOz / BatchQuantity
    ...
    def compare_products_incompatibilities(self):
        ...
        try:
            # Show all product batches with numbers
            self.cursor.execute("""
                SELECT 
                    pb.LotID,
                    p.ProductID,
            ...
            for result in self.cursor.stored_results():
                ...
                if rows:
                    ...
                    print("Note: Conflicts based on actual formulations used in production.")
                else:
