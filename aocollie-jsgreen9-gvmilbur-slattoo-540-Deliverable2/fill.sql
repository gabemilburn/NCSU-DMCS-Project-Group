...
VALUES 
    ('101-20-B0001', 2, 1000, '2025-11-15', NULL),    
    ('101-21-B0001', 3, 800, '2025-10-30', NULL),     
    ('101-20-B0002', 2, 350,'2025-11-01', 2),        
    ('101-20-B0003', 2, 500, '2025-12-15', NULL);      

INSERT INTO IngredientBatch (LotID, FormulationID, Quantity, ExpirationDate, ManufacturerID) 
VALUES 
    ('102-20-B0001', 4, 600, '2025-12-15', 2);  
    
INSERT INTO IngredientBatch (LotID, FormulationID, Quantity, ExpirationDate, ManufacturerID) 
VALUES 
    ('106-20-B0005', 5, 3000, '2025-12-15', NULL),   
    ('106-20-B0006', 5, 0, '2025-12-20', 1);            

INSERT INTO IngredientBatch (LotID, FormulationID, Quantity, ExpirationDate, ManufacturerID) 
VALUES 
    ('108-20-B0001', 6, 1000, '2025-09-28', NULL),   
    ('108-20-B0003', 6, 4200, '2025-12-31', 2);     
    
INSERT INTO IngredientBatch (LotID, FormulationID, Quantity, ExpirationDate, ManufacturerID) 
VALUES 
    ('201-20-B0001', 1, 100, '2025-11-30', NULL),     
    ('201-20-B0002', 1, 17.5, '2025-12-30', 1);     
...
BEGIN
    ...
    IF NOW() > OLD.ExpirationDate THEN
        ...
        -- Calculate old and new total oz
...
BEGIN
    ...
    -- Calculate new quantity in packages
