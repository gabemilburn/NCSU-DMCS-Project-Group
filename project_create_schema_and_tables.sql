...
DROP TABLE IF EXISTS `csc540_project`.`donotcombinelist`, `csc540_project`.`formulation`,
                     `csc540_project`.`formulationingredientlist`, `csc540_project`.`ingredient`,
                     `csc540_project`.`ingredientbatch`, `csc540_project`.`manufacturer`,
                     `csc540_project`.`product`, `csc540_project`.`productbatch`,
                     `csc540_project`.`productbatchingredientbatch`, `csc540_project`.`productcategory`,
                     `csc540_project`.`recipe`, `csc540_project`.`recipebom`,
                     `csc540_project`.`supplier`, `csc540_project`.`user`;
...
CREATE TABLE IngredientBatch (
    ...
    FormulationID INT NOT NULL,
	ManufacturerID INT,
	Quantity DEC(10,2) NOT NULL CHECK (Quantity >= 0),
